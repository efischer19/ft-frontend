...
describe('BlogImg.vue', () => {
  it('renders props from public image', () => {
    const link = { public: '20180707_test_image.jpg' };
  ...
  it('renders props from private image', () => {
    const links = {
      small: 'https://presigned.by.aws/totally_real/20180707_test_image.small.jpg',
      large: 'https://presigned.by.aws/totally_real/20180707_test_image.jpg',
    };
    const alt = 'a totally real and not at all made up image';
    const id = 'mc';
